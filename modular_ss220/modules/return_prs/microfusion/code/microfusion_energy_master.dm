...
/obj/item/gun/microfusion
	...
	icon = 'modular_ss220/modules/return_prs/microfusion/icons/microfusion_gun40x32.dmi'
	icon_state = "mcr01"
	inhand_icon_state = "mcr01"
	lefthand_file = 'modular_ss220/modules/return_prs/microfusion/icons/guns_lefthand.dmi'
	righthand_file = 'modular_ss220/modules/return_prs/microfusion/icons/guns_righthand.dmi'
	...
	var/sound_cell_insert = 'modular_ss220/modules/return_prs/microfusion/sound/mag_insert.ogg'
	...
	var/sound_cell_remove = 'modular_ss220/modules/return_prs/microfusion/sound/mag_insert.ogg'
...
/obj/item/gun/microfusion/can_shoot()
	return !QDELETED(cell) ? (cell.charge >= (microfusion_lens ? microfusion_lens.e_cost + extra_power_usage : 0)) : FALSE
...
/obj/item/gun/microfusion/process_fire(atom/target, mob/living/user, message = TRUE, params = null, zone_override = "", bonus_spread = 0)
	...
	if(burst_size > 1)
		...
		if (!QDELETED(src))
			...
			update_appearance()
			fire_cd = TRUE
			addtimer(CALLBACK(src, PROC_REF(reset_fire_cd)), modified_fire_delay + fire_delay_to_add)
			addtimer(CALLBACK(src, PROC_REF(reset_fire_cd)), modified_fire_delay + fire_delay_to_add)
