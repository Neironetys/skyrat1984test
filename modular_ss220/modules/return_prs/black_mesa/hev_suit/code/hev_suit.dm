...
/obj/item/clothing/head/helmet/space/hev_suit
	...
	clothing_flags = STOPSPRESSUREDAMAGE|THICKMATERIAL|SNUG_FIT|LAVAPROTECT|BLOCK_GAS_SMOKE_EFFECT|HEADINTERNALS|STACKABLE_HELMET_EXEMPT
...
/obj/item/clothing/suit/space/hev_suit
	...
	///Lots of sound vars.
	var/activation_song = 'modular_ss220/modules/return_prs/black_mesa/hev_suit/sound/hev/anomalous_materials.ogg'

	var/logon_sound = 'modular_ss220/modules/return_prs/black_mesa/hev_suit/sound/hev/01_hev_logon.ogg'
	var/armor_sound = 'modular_ss220/modules/return_prs/black_mesa/hev_suit/sound/hev/02_powerarmor_on.ogg'
	var/atmospherics_sound = 'modular_ss220/modules/return_prs/black_mesa/hev_suit/sound/hev/03_atmospherics_on.ogg'
	var/vitalsigns_sound = 'modular_ss220/modules/return_prs/black_mesa/hev_suit/sound/hev/04_vitalsigns_on.ogg'
	var/automedic_sound = 'modular_ss220/modules/return_prs/black_mesa/hev_suit/sound/hev/05_automedic_on.ogg'
	var/weaponselect_sound = 'modular_ss220/modules/return_prs/black_mesa/hev_suit/sound/hev/06_weaponselect_on.ogg'
	var/munitions_sound = 'modular_ss220/modules/return_prs/black_mesa/hev_suit/sound/hev/07_munitionview_on.ogg'
	var/communications_sound = 'modular_ss220/modules/return_prs/black_mesa/hev_suit/sound/hev/08_communications_on.ogg'
	var/safe_day_sound = 'modular_ss220/modules/return_prs/black_mesa/hev_suit/sound/hev/09_safe_day.ogg'

	var/batt_50_sound = 'modular_ss220/modules/return_prs/black_mesa/hev_suit/sound/hev/power_level_is_fifty.ogg'
	var/batt_40_sound = 'modular_ss220/modules/return_prs/black_mesa/hev_suit/sound/hev/power_level_is_fourty.ogg'
	var/batt_30_sound = 'modular_ss220/modules/return_prs/black_mesa/hev_suit/sound/hev/power_level_is_thirty.ogg'
	var/batt_20_sound = 'modular_ss220/modules/return_prs/black_mesa/hev_suit/sound/hev/power_level_is_twenty.ogg'
	var/batt_10_sound = 'modular_ss220/modules/return_prs/black_mesa/hev_suit/sound/hev/power_level_is_ten.ogg'

	var/near_death_sound = 'modular_ss220/modules/return_prs/black_mesa/hev_suit/sound/hev/near_death.ogg'
	var/health_critical_sound = 'modular_ss220/modules/return_prs/black_mesa/hev_suit/sound/hev/health_critical.ogg'
	var/health_dropping_sound = 'modular_ss220/modules/return_prs/black_mesa/hev_suit/sound/hev/health_dropping2.ogg'

	var/blood_loss_sound = 'modular_ss220/modules/return_prs/black_mesa/hev_suit/sound/hev/blood_loss.ogg'
	var/blood_toxins_sound = 'modular_ss220/modules/return_prs/black_mesa/hev_suit/sound/hev/blood_toxins.ogg'
	var/biohazard_sound = 'modular_ss220/modules/return_prs/black_mesa/hev_suit/sound/hev/biohazard_detected.ogg'
	var/chemical_sound = 'modular_ss220/modules/return_prs/black_mesa/hev_suit/sound/hev/chemical_detected.ogg'
	var/radiation_sound = 'modular_ss220/modules/return_prs/black_mesa/hev_suit/sound/hev/radiation_detected.ogg'

	var/minor_fracture_sound = 'modular_ss220/modules/return_prs/black_mesa/hev_suit/sound/hev/minor_fracture.ogg'
	var/major_fracture_sound = 'modular_ss220/modules/return_prs/black_mesa/hev_suit/sound/hev/major_fracture.ogg'
	var/minor_lacerations_sound = 'modular_ss220/modules/return_prs/black_mesa/hev_suit/sound/hev/minor_lacerations.ogg'
	var/major_lacerations_sound = 'modular_ss220/modules/return_prs/black_mesa/hev_suit/sound/hev/major_lacerations.ogg'

	var/morphine_sound = 'modular_ss220/modules/return_prs/black_mesa/hev_suit/sound/hev/morphine_shot.ogg'
	var/wound_sound = 'modular_ss220/modules/return_prs/black_mesa/hev_suit/sound/hev/wound_sterilized.ogg'
	var/antitoxin_sound = 'modular_ss220/modules/return_prs/black_mesa/hev_suit/sound/hev/antitoxin_shot.ogg'
	var/antidote_sound = 'modular_ss220/modules/return_prs/black_mesa/hev_suit/sound/hev/antidote_shot.ogg'
...
/datum/action/item_action/hev_toggle
	...
	button_icon = 'modular_ss220/modules/return_prs/black_mesa/hev_suit/icons/toggles.dmi'
...
/datum/action/item_action/hev_toggle_notifs/Trigger(trigger_flags)
	...
	playsound(my_suit, 'modular_ss220/modules/return_prs/black_mesa/hev_suit/sound/hev/blip.ogg', 50)
...
/obj/item/clothing/suit/space/hev_suit/proc/stat_changed(datum/source, new_stat)
	SIGNAL_HANDLER
	if(new_stat == DEAD)
		playsound(src, 'modular_ss220/modules/return_prs/black_mesa/hev_suit/sound/hev/flatline.ogg', 40)
...
/obj/item/clothing/suit/space/hev_suit/pcv
	...
	logon_sound = 'modular_ss220/modules/return_prs/black_mesa/hev_suit/sound/pcv/01_pcv_logon.ogg'
